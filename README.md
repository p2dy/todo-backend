...
The primary aim of this project is to get to know and play around with Quarkus. This project uses
...
You can then execute your native executable with: `./build/todo-backend-1.0-SNAPSHOT-runner`
