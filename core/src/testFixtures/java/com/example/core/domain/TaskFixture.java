...
public class TaskFixture {
    ...
    public static final Task TASK_TO_ADD = Task.create(TASK_ID_TO_ADD, CREATED_BOARD.getId(), Title.of("Wash the dishes"));
    public static final Task ADDED_TASK = Task.create(ADDED_TASK_ID, CREATED_BOARD.getId(), Title.of("Clean up the laundry room"));
}
