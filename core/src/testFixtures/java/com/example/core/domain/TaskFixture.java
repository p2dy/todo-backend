...
import static com.example.core.domain.ProgressFixtures.DONE;
...
public class TaskFixture {
    ...
    public static final Task TASK_TO_ADD = new Task(TASK_TO_ADD_ID, Title.of("Wash the dishes"), TODO.getId());
    public static final Task ADDED_TASK = new Task(ADDED_TASK_ID, Title.of("Clean up the laundry room"), DONE.getId());
}
