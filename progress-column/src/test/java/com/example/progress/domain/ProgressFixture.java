...
public class ProgressFixture {
    ...
    public static final Progress IN_PROGRESS = Progress.create(IN_PROGRESS_ID, IN_PROGRESS_TITLE);
    public static final Progress IN_REVIEW = Progress.create(IN_REVIEW_ID, IN_REVIEW_TITLE);
